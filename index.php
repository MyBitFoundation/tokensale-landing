...
<div class="wrapper">
    ...
    <div id="team" class="section__team">
        ...
        <div class="subscribe__wrap">
            ...
            <form id="subscribe_form_bottom" class="form" action="//mybit.us15.list-manage.com/subscribe/post?u=af48b1fdb5278fd9884338f23&amp;id=dbcac41639" method="post" name="mc-embedded-subscribe-form" target="_blank" novalidate>
                <div class="form__row">
                    <a href="javascript:;" onclick="$('#subscribe_form_bottom').submit();" class="btn btn-form">Subscribe</a>
                    <div class="input__extend">
                        <input type="email" placeholder="Your Email" name="EMAIL" class="input input-bordered"/>
                        <div style="position: absolute; left: -5000px;" aria-hidden="true">
                            <input type="text" name="b_af48b1fdb5278fd9884338f23_dbcac41639" tabindex="-1" value="">
                        </div>
                    </div>
